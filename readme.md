...
A lightweight, zero-dependency, local web GUI for chatting with AI models
(learn more about [Chatbots on Wikipedia](https://wikipedia.org/wiki/Chatbot)).
It natively supports live-streaming, file uploads, and advanced Markdown
rendering—all built using pure Go and standard HTML/CSS with **zero
JavaScript**.
